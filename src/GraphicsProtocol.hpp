...
struct PathCommand {
    ...
    PathGradient strokeGradientPaint{};
    ...
    struct TexturePaint {
        ...
        PathRect sourceRect{};
        ClipRect uv{0.0F, 0.0F, 1.0F, 1.0F};
        Color tint{1.0F, 1.0F, 1.0F, 1.0F};
    };
    bool fillTexture = false;
    bool strokeTexture = false;
...
struct RadialGradientTextCommand {
    TextCommand text;
    PathCommand::RadialGradient gradient;
    bool objectBoundingBox = false;
};
...
public:
    ...
    void drawRadialGradientText(const RadialGradientTextCommand& text);
    ...
    void drawGradientArc(const GradientArcCommand& arc);
    ...
    void drawGridPattern(const GridPatternCommand& pattern);
...
bool decodeRadialGradientText(const CommandView& command, RadialGradientTextCommand& text);
